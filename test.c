...
static void test_parse_root_not_singular() {
  printf("test_parse_root_not_singular:\n");
...
static void test_parse_number_too_big() {
  printf("test_parse_number_too_big:\n");
#if 1
...
static void test_parse_miss_quotatioin_mark() {
...
static void test_access_number() {
  printf("test_access_number:\n");
  lept_value v;
  lept_init(&v);
  lept_set_string(&v, "a", 1);
  lept_set_number(&v, 1.7976931348623157);
  EXPECT_EQ_DOUBLE(1.7976931348623157, lept_get_number(&v));
  lept_free(&v);
}

static void test_access_string() {
  printf("test_access_string:\n");
  lept_value v;
  lept_init(&v);
  lept_set_string(&v, "", 0);
...
static void test_stringify_array() {
  printf("test_stringify_array:\n");
  TEST_ROUNDTRIP("[]");
  TEST_ROUNDTRIP("[null,false,true,123,\"abc\",[1,2,3]]");
}

static void test_stringify_object() {
  printf("test_stringify_object:\n");
  TEST_ROUNDTRIP("{}");
...
static void test_parse() {
  ...
  test_parse_miss_quotatioin_mark();
